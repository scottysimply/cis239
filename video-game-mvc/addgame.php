...
<div class="container mt-5 col-5 col-3-md">
    ...
    <form method="post" class="form border p-2 border-primary-subtle rounded" enctype="multipart/form-data">
        ...
        <input type="text" name="gameTitle" id="game-title" class="mb-2 w-100"><br/>
        <?php
        ...
        <input type="text" name="gameGenre" id="game-genre" class="mb-2 w-100"><br/>
        <?php
        ...
        <input type="text" name="gamePlatform" id="game-platform" class="mb-2 w-100"><br/>
        <?php
        ...
        <input type="file" name="gameImage" id="game-image" class="mb-2"><br/>
        <?php
